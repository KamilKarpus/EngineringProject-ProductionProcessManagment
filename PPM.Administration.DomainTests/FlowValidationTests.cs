...
namespace PPM.Administration.DomainTests
{
    public class FlowValidationTests
    {
        ...
        public FlowValidationTests()
        {
            ...
            _flow.AddStep(Guid.NewGuid(), "test6", 10, Guid.NewGuid(), 20, _locationExistence.Object, _supportPrinting.Object);
        ...
        {
            _flow.AddStep(Guid.NewGuid(), "test6", 10, Guid.NewGuid(), 105, _locationExistence.Object, _supportPrinting.Object);
            var validator = new ProductionFlowValidator();
        ...
        {
            _flow.AddStep(Guid.NewGuid(), "test6", 10, Guid.NewGuid(), 95, _locationExistence.Object, _supportPrinting.Object);
            var validator = new ProductionFlowValidator();
            Assert.False(validator.IsValid(_flow));
