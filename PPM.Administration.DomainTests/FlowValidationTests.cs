...
namespace PPM.Administration.DomainTests
{
    public class FlowValidationTests
    {
        ...
        public FlowValidationTests()
        {
            ...
            _flow.AddStep(Guid.NewGuid(), "test1", 5, Guid.NewGuid(), 0, _locationExistence.Object);
            _flow.AddStep(Guid.NewGuid(), "test2", 5, Guid.NewGuid(), 10, _locationExistence.Object);
            _flow.AddStep(Guid.NewGuid(), "test6", 10, Guid.NewGuid(), 20, _locationExistence.Object);
            _flow.AddStep(Guid.NewGuid(), "test4", 3, Guid.NewGuid(), 60, _locationExistence.Object);
            _flow.AddStep(Guid.NewGuid(), "test5", 7, Guid.NewGuid(), 95, _locationExistence.Object);
            _flow.AddStep(Guid.NewGuid(), "test6", 10, Guid.NewGuid(), 100, _locationExistence.Object);
        }
        [Fact]
        ...
        {
            _flow.AddStep(Guid.NewGuid(), "test6", 10, Guid.NewGuid(), 105, _locationExistence.Object);
            var validator = new ProductionFlowValidator();
        ...
        {
            _flow.AddStep(Guid.NewGuid(), "test6", 10, Guid.NewGuid(), 95, _locationExistence.Object);
            var validator = new ProductionFlowValidator();
            Assert.False(validator.IsValid(_flow));
